...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_2.setGeometry(QtCore.QRect(120, 50, 241, 200))
        self.label_2.setText("")
        self.label_2.setPixmap(QtGui.QPixmap("Arrows.svg"))
        self.label_2.setObjectName("label_2")
        self.input_currency = QtWidgets.QLineEdit(self.centralwidget)
        self.input_currency.setGeometry(QtCore.QRect(60, 280, 380, 60))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.input_currency.setTabletTracking(False)
        self.input_currency.setFocusPolicy(QtCore.Qt.ClickFocus)
...
"color: rgb(160, 160, 160);")
        ...
        self.input_amount.setFocusPolicy(QtCore.Qt.ClickFocus)
...
"color: black;")
        ...
        self.output_currency.setGeometry(QtCore.QRect(60, 420, 380, 60))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(14)
        font.setBold(True)
        ...
        self.output_currency.setFocusPolicy(QtCore.Qt.ClickFocus)
...
"color: black;")
        ...
        self.output_amount.setGeometry(QtCore.QRect(60, 490, 380, 60))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(14)
        font.setBold(True)
        ...
        self.output_amount.setFocusPolicy(QtCore.Qt.TabFocus)
...
"color: black;")
        ...
        self.pushButton.setGeometry(QtCore.QRect(60, 560, 380, 60))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(18)
        font.setBold(True)
